...
local CREDENTIAL_INVALID = {
    ...
    headers = {
        ['WWW-Authenticate'] = 'Bearer realm="service" ' ..
            'error="invalid_token" ' .. 'error_description="Invalid audience, issuer, or client_id"'
    }
}
...
local INSUFFICIENT_SCOPE = {
    ...
    headers = {
        ['WWW-Authenticate'] = 'Bearer realm="service" ' ..
            'error="insufficient_scope" ' .. 'error_description="Missing required audience or scope"'
    }
}
